          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/dashboard" className="waves-effect">
                ...
                <span>{props.t("LiveCapture")}</span>
              </Link>
            </li>
            <li>
              <Link to="/uploadcapture" className="waves-effect">
                <i className="mdi mdi-view-dashboard"></i>
                <span className="badge rounded-pill bg-primary float-end">3</span>
                <span>{props.t("Upload Capture")}</span>
              </Link>
            </li>
{/* 
            <li>
